...
<div class="container-fluid p-3 bg-light">
	<div class="row">
		<div class="col-md-3">
			<h3 class="Bookmate-header">
				<i class="fa-solid fa-book "></i> BOOK-MATE
			</h3>
		</div>
		<div class="col-md-6">
		...
		<a href=checkout.jsp><i class="fa-solid fa-cart-shopping fa-2x text-center" style="font-size:20px;">Cart</i></a><br>
	...
	<div class="collapse navbar-collapse" id="navbarSupportedContent">
		<ul class="navbar-nav mr-auto">
			...
			<li class="nav-item active"><a class="nav-link " href="all_old_book.jsp"><i
					class="fa-solid fa-book-bookmark"></i> Old Books</a></li>
		</ul>
		<form class="form-inline my-2 my-lg-0">
